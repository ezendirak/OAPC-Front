...
@Component({
  selector: 'app-taula-productes',
  templateUrl: './taula-productes.component.html',
  styleUrls: ['./taula-productes.component.css']
})
export class TaulaProductesComponent implements OnInit {
